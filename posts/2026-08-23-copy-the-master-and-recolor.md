...
|Met Office Hadley Centre & Climatic Research Unit. (2025). HadCRUT.5.1.0.0 data download [Data set]. Met Office. https://www.metoffice.gov.uk/hadobs/hadcrut5/data/HadCRUT.5.1.0.0/download.html 

The specific file used is the “Global (NH+SH)/2 - Annual” CSV which is listed under “HadCRUT5 analysis time series: ensemble means and uncertainties" section of the download page above.
...
|X axis: Year – Years from 1850 to 2025 with 25-year intervals 

Y axis: Global mean temperature change in °C.|

 

|**Important Notes**|

|Baseline mismatch: The Met Office’s HadCRUT5 csv file shows temperature changes relative to a 1961-1990 baseline. 
The original Show Your Stripes visualization shows this same data to a 1961-2010 baseline (Hawkins et al., 2025).  

As a result, the csv file values are less negative than the ones in the chart. To make sure my replication is comparable to the original, the downloaded values were re-baselined by subtracting the mean temperature for 1961-2010 from every year’s value.  

2026 excluded: The most recent year in the downloaded file (2026) was excluded from the replication as data for this year is still being collected 

Ensemble based estimate: The values in the dataset aren’t single measurements. They are calculated by taking the average of 200 slightly different estimates (Morice et al., 2021).|


|**References**|

|Hawkins, E., Williams, R. G., Young, P. J., Berardelli, J., Burgess, S. N., Highwood, E., Randel, W., Roussenov, V., Smith, D., & Woods Placky, B. (2025). Warming stripes spark climate conversations: From the ocean to the stratosphere. Bulletin of the American Meteorological Society, 106(5). https://doi.org/10.1175/BAMS-D-24-0212.1 
...
|You can get a copy of the data used to build this visualization by downloading it from the Met Office HadCRUT5 page: 

https://www.metoffice.gov.uk/hadobs/hadcrut5/data/HadCRUT.5.1.0.0/download.html 

The specific dataset is “Global (NH+SH)/2, Annual CSV” under ensemble means and uncertainties table|
