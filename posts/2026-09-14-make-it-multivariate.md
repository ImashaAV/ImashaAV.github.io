...
|**Data Sources**| Our World in Data. (2026). CO₂ emissions from fossil fuels and land-use change [Data set]. https://ourworldindata.org/grapher/co2-fossil-plus-land-use Gcarbonproject. (n.d.). Home. Retrieved from https://globalcarbonbudget.org/ All data was retrieved from OWID’s own csv download for the chart. |
