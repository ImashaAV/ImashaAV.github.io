...
|**Access** | Original visualization: https://ourworldindata.org/grapher/co2-fossil-plus-land-use Data download: Available directly from the “Download” icon on the same OWID chart page|
